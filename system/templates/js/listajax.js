...
function GetList2(par_tbn, par_cid,par_flag, par_page, par_keyword, par_ver)
{
	pag     = par_tbn;
	tbn     = par_tbn;
	cid     = par_cid;
	...
	$.ajax({
		url : pag+"_do.php?tbname="+tbn+"&cid="+cid+"&tid="+tid+"&flag="+flag+"&keyword="+encodeURI(keyword)+"&page="+page+"&ver="+ver,
		type:'get',
		dataType:'html',
		beforeSend:function(){
			$("body").append('<div class="loading4"></div><div class="masklayer"></div>');
...
//中英文
function GetVersion( par_ver, classname, obj)
{
	ver = par_ver;
	...
	$.ajax({
		url : pag+"_do.php?tbname="+tbn+"&cid="+cid+"&tid="+tid+"&flag="+flag+"&ver="+ver,
		type:'get',
		dataType:'html',
		beforeSend:function(){
			$(".masklayer").css("height",$(document).height()).show();
...
function GetFlag(par_flag)
{
	...
	$.ajax({
		url : pag+"_do.php?tbname="+tbn+"&cid="+cid+"&tid="+tid+"&flag="+flag+"&keyword="+encodeURI(keyword)+"&page=1"+"&ver="+ver,
		type:'get',
		dataType:'html',
		beforeSend:function(){
			$(".masklayer").css("height",$(document).height()).show();
...
function GetSearch()
{
	...
	$.ajax({
		url : pag+"_do.php?tbname="+tbn+"&cid="+cid+"&tid="+tid+"&flag="+flag+"&keyword="+encodeURI(keyword)+"&ver="+ver,
		type:'get',
		dataType:'html',
		beforeSend:function(){
			$(".masklayer").css("height",$(document).height()).show();
