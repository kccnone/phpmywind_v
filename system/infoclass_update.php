...
<form name="form" id="form" method="post" action="infoclass_save.php" onsubmit="return cfm_infoclass();">
	<table width="100%" border="0" cellspacing="0" cellpadding="0" class="formTable">
		...
		<tr>
			<td height="40" align="right">英文栏目名称：</td>
			<td><input name="classname_en" type="text" id="classname_en" value="<?php echo $row['classname_en']; ?>"  class="input" /></td>
			<td>&nbsp;</td>
		</tr>
		<tr>
		...
		?>
		<input name="linkurl" type="hidden" id="linkurl" class="input" value="<?php echo $row['linkurl']; ?>" />
        <input name="seotitle" type="hidden" id="seotitle" class="input" value="<?php echo $row['seotitle']; ?>" />
        <input name="keywords" type="hidden" id="keywords" class="input" value="<?php echo $row['keywords']; ?>" />
        <input name="description" type="hidden" id="description" class="input" value="<?php echo $row['description']; ?>" />
        <?php
		}
		?>        
	</table>
