...
$(function(){
	GetList2('friendship','<?php echo ($cid = isset($cid) ? $cid : ''); ?>','<?php echo ($flag = isset($flag) ? $flag : 'all'); ?>','<?php echo ($page = isset($page) ? $page : 1); ?>','<?php echo ($keyword = isset($keyword) ? $keyword : ''); ?>','<?php echo ($ver = isset($ver) ? $ver : ''); ?>');
})
</script>
</head>
<body>
<div class="topToolbar"> <span class="title">信息管理</span>
<span class="alltype">
	<a href="javascript:;" onclick="GetType('','全部栏目',$(this))" class="btn">全部栏目</a>
	<span class="drop">
	<?php GetMgrAjaxType('#@__infoclass',14); ?>
	</span>
</span>
<span class="alltype">
