...
?>
<div class="formHeader"> <span class="title">修改产品信息</span> <a href="javascript:location.reload();" class="reload">刷新</a> </div>
<form name="form" id="form" method="post" action="goods_save.php" onsubmit="return cfm_goods();">
	<table width="100%" border="0" cellspacing="0" cellpadding="0" class="formTable">
		...
		<tr>
			<td height="40" align="right">产品分类：</td>
		...
		<tr>
			<td height="40" align="right">产品品牌：</td>
		...
		{
			echo '<div style="text-align:center;color:#9C0;">暂无自定义属性，您可以在产品分类中进行添加</div>';
		}
		?>
		<tr class="nb">
			<td colspan="2" height="26"><div class="line"></div></td>
		...
		<tr>
			<td height="40" align="right">产品价格：</td>
