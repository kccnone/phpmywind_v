	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0" class="dataTable">
		<tr align="left" class="dataTr">
			...
			<td width="55%" class="privTxt">
				...
				删除</span>
                <span>
				<input type="checkbox" name="priv[<?php echo $siteid; ?>][<?php echo $row['id']; ?>][]" value="listc" />
				查看栏目</span> 
                <span>
				<input type="checkbox" name="priv[<?php echo $siteid; ?>][<?php echo $row['id']; ?>][]" value="addc" />
				添加栏目</span>
                <span>
				<input type="checkbox" name="priv[<?php echo $siteid; ?>][<?php echo $row['id']; ?>][]" value="updatec" />
				修改栏目</span> 
                <span>
				<input type="checkbox" name="priv[<?php echo $siteid; ?>][<?php echo $row['id']; ?>][]" value="delc" />
				删除栏目</span>
                <span>
				<input type="checkbox" name="priv[<?php echo $siteid; ?>][<?php echo $row['id']; ?>][]" value="youhc" />
				优化栏目</span>
          	</td>
		</tr>
	</table>
