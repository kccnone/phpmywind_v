		...
		<div class="overview">
			...
			else
			{
				...
				$leftMenu02_Arr = array('infoclass'=>'<a href="infoclass.php" target="main">栏目管理</a>',
									...
									'vedio'=>'<a href="vedio.php" target="main">视频信息管理</a>',
									'friendship'=>'<a href="friendship.php" target="main">友情链接信息管理</a>',
									'spring'=>'<a href="spring.php" target="main">预定义一信息管理</a>',
									'summer'=>'<a href="summer.php" target="main">预定义二信息管理</a>',
									'autumn'=>'<a href="autumn.php" target="main">预定义三信息管理</a>',
									'winter'=>'<a href="winter.php" target="main">预定义四信息管理</a>',
									'east'=>'<a href="east.php" target="main">预定义五信息管理</a>',
									'west'=>'<a href="west.php" target="main">预定义六信息管理</a>',
									'north'=>'<a href="north.php" target="main">预定义七信息管理</a>',
									'south'=>'<a href="south.php" target="main">预定义八信息管理</a>',
				...
				$leftMenu04_Str = '';
				$leftMenu04_Arr = array('goodstype'=>'<a href="goodstype.php" target="main">产品类别管理</a>',
									'goodsbrand'=>'<a href="goodsbrand.php" target="main">品牌类型管理</a>',
									'goods'=>'<a href="goods.php" target="main">产品列表管理</a>',
									'goodsorder'=>'<a href="goodsorder.php" target="main">产品订单管理</a>',
									...
									'goodsflag'=>'<a href="goodsflag.php" target="main" title="产品信息属性管理" class="goodsinfoattr"></a>');
				...
				if($leftMenu04_Str != '')
				{
					...
					if($leftMenu01_Str != '' or
					   ...
					   $leftMenu03_Str != '')
					{
						echo '<div class="menubox"><div class="title" onclick="DisplayMenu(\'leftmenu04\');" title="点击切换显示或隐藏"> 产品订单管理 </div><div id="leftmenu04" style="display:none">';
					}
					else
					{
						echo '<div class="menubox"><div class="title on" id="t1" onclick="DisplayMenu(\'leftmenu04\');" title="点击切换显示或隐藏"> 产品订单管理 </div><div id="leftmenu04">';
					}
			...
			?>
			<div class="menubox">
				<div class="title" onclick="DisplayMenu('leftmenu<?php echo $i; ?>');" title="点击切换显示或隐藏">操作日志管理</div>
				<div id="leftmenu<?php echo $i; ?>" class="undis">
					<a href="sysevent_nor.php" target="main">操作日志</a>
				</div>
			</div>
			<div class="hr_5"></div>
			<!--scrollbar end-->
