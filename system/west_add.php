...
<form name="form" id="form" method="post" action="west_save.php" onsubmit="return cfm_infolm();">
	<table width="100%" border="0" cellspacing="0" cellpadding="0" class="formTable">
		...
		<tr class="nb">
			<td colspan="2" height="0" id="df"><?php if(isset($cid)) echo GetDiyField(11,$cid); ?></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td><input type="text" name="orderid" id="orderid" class="inputos" value="<?php echo GetOrderID('#@__west'); ?>" /></td>
		</tr>
		<tr>
