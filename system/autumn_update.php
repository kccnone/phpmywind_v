...
<body>
<?php
$row = $dosql->GetOne("SELECT * FROM `#@__autumn` WHERE `id`=$id");
?>
<div class="formHeader"> <span class="title">修改列表信息</span> <a href="javascript:location.reload();" class="reload">刷新</a> </div>
<form name="form" id="form" method="post" action="autumn_save.php" onsubmit="return cfm_infolm();">
	<table width="100%" border="0" cellspacing="0" cellpadding="0" class="formTable">
		...
		<tr>
			...
			<td><select name="mainid" id="mainid">
					...
					<?php GetAllType('#@__maintype','#@__autumn','mainid'); ?>
				</select>
		...
		<tr class="nb">
			...
			echo GetDiyField('8',$row['classid'],$row);
			?></td>
		</tr>
		<tr>
