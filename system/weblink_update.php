...
<form name="form" id="form" method="post" action="weblink_save.php" onsubmit="return cfm_weblink();">
	<table width="100%" border="0" cellspacing="0" cellpadding="0" class="formTable">
        ...
        <tr class="nb">
			<td height="40" align="right">新窗口打开：</td>
			<td><input type="radio" name="istarget" value="true" <?php if($row['istarget'] == 'true'){echo 'checked="checked"';} ?> />
				是 &nbsp;
				<input type="radio" name="istarget" value="false" <?php if($row['istarget'] == 'false'){echo 'checked="checked"';} ?> />
