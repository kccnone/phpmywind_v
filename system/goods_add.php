...
<body>
<div class="formHeader"> <span class="title">添加产品信息</span> <a href="javascript:location.reload();" class="reload">刷新</a> </div>
<form name="form" id="form" method="post" action="goods_save.php" onsubmit="return cfm_goods();">
	<table width="100%" border="0" cellspacing="0" cellpadding="0" class="formTable">
		...
		<tr class="nb">
			<td colspan="2" height="26" id="getattr"><div style="text-align:center;color:#9C0;">请选择产品分类获取自定义属性</div></td>
		</tr>
		<tr class="nb">
			<td colspan="2" height="26"><div class="line"></div></td>
		</tr>
