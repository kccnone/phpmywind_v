...
$(function(){
	GetList2('north','<?php echo ($cid = isset($cid) ? $cid : ''); ?>','<?php echo ($flag = isset($flag) ? $flag : 'all'); ?>','<?php echo ($page = isset($page) ? $page : 1); ?>','<?php echo ($keyword = isset($keyword) ? $keyword : ''); ?>','<?php echo ($ver = isset($ver) ? $ver : ''); ?>');
})
</script>
</head>
<body>
...
<span class="alltype">
	...
	<span class="drop">
	<?php GetMgrAjaxType('#@__infoclass',13); ?>
	</span>
</span>
<span class="alltype">
