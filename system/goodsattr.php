...
?>
<div class="topToolbar"> <span class="title">产品属性管理</span> <span class="text">当前分类：<a href="goodstype.php" title="点击返回产品分类"><?php echo $classname; ?></a></span> <a href="javascript:location.reload();" class="reload">刷新</a></div>
<form name="form" id="form" method="post" action="goodsattr_save.php?action=save">
	<table width="100%" border="0" cellpadding="0" cellspacing="0" class="dataTable">
		...
		?>
		<tr align="center">
			<td colspan="6" class="dataEmpty">产品类型获取出错，请返回 <a href="goodstype.php">产品类型管理</a></td>
		</tr>
		<?php
		}
		?>
