...
if(phpversion() < '5.0')
{
	exit('用户您好，由于您的php版本过低，不能安装本软件，为了系统功能全面可用，请升级到5.0或更高版本再安装，谢谢！<br />您可以登录kccn.net 获取更多帮助');
}
...
else if($s == 3)
{
	...
	if($_POST['s'] == 3)
	{
		...
		if($conn)
		{
			...
			//创建管理员
			mysql_query("INSERT INTO `".$tbpre."admin` VALUES('1','".$username."','".md5(md5($password))."','','0','','1','true','127.0.0.1','".time()."','true');");
			...
			INSERT INTO `#@__webconfig` VALUES('1','cfg_author','网站作者','0','string','杭州金创科技','4');
			INSERT INTO `#@__webconfig` VALUES('1','cfg_generator','程序引擎','0','string','kccn.net','5');
			...
			INSERT INTO `#@__webconfig` VALUES('1','cfg_copyright','版权信息','0','bstring','Copyright © 2010 - 2015  All Rights Reserved','8');
			...
			INSERT INTO `#@__webconfig` VALUES('1','cfg_mobile','自动跳转手机版','2','bool','N','43');
			...
			INSERT INTO `#@__webconfig` VALUES('1','cfg_isguide','开启新手导航','2','bool','Y','51');
			...
			INSERT INTO `#@__webconfig` VALUES('1','cfg_reurl_goods','产品展示页','3','string','{goods}-{cid}-{tid}-{page}.html','75');
			INSERT INTO `#@__webconfig` VALUES('1','cfg_reurl_goodsshow','产品内容页','3','string','{goodsshow}-{cid}-{tid}-{id}-{page}.html','76');
